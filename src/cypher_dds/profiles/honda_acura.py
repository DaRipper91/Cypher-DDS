...
Its stub-proving job is done — see honda_acura.py's history for how the
...
# Honda/Acura manufacturer-specific (P1xxx) DTC definitions, sourced from
# public OBD-II reference documentation. Covers 1996+ Honda/Acura platforms.
# TODO: expand with B/C/U-series codes and enhanced (Mode 22) PIDs.
DTC_TABLE: dict[str, str] = {
    # Sensors: BARO, throttle/MAP, accelerator position, O2/HO2S, ELD
    ...
    # Misfire (two ranges — P12xx and P13xx both used across Honda platforms)
    ...
    # Automatic transmission control (TCM) / traction control
    ...
    # Shared description across this whole group per source documentation
    "P1709": "Automatic Transmission System Malfunction",
    "P1738": "Automatic Transmission System Malfunction",
    "P1739": "Automatic Transmission System Malfunction",
    "P1768": "Automatic Transmission System Malfunction",
    "P1773": "Automatic Transmission System Malfunction",
    "P1788": "Automatic Transmission System Malfunction",
    "P1793": "Automatic Transmission System Malfunction",
