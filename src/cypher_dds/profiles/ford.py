...
# OBD-II reference documentation. Covers 1996+ Ford platforms (includes
...
DTC_TABLE: dict[str, str] = {
    ...
    # Water/fuel restriction, pedal position
    ...
    # Charging / rotor / traction control
    ...
    # Diesel: engine oil temp, injection control pressure, cylinder head temp
    ...
    # Cylinder injector high/low-side circuits (diesel)
    ...
    # Ignition coils / ignition diagnostic monitor
    ...
    # Variable Cam Timing / glow plugs (diesel)
    ...
    # Vehicle speed / idle air control / intake manifold runner control
    ...
    # Electronic throttle control (ETC) / speed control (cruise)
    ...
    # Module communication / CAN / KAM / theft
